...
- `[ ]` Görev 1.5: Cloudflare DNS Yapılandırmasının Belgelenmesi. V1.4 Orchestrator mimarisinde Edge node'ların (Node1 ve Node4) istemcilere doğrudan public hizmet verebilmesi için gerekli olan çoklu subdomain (örn: `edge1-live.teqlif.com`, `edge2-minio.teqlif.com`) A kayıtlarının belirlenip `.env` şablonları ile senkronize edilmesi. (Commit: -, Date: -)
