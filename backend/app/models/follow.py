...
from sqlalchemy import DateTime, ForeignKey, UniqueConstraint, func, String
...
class Follow(Base):
    ...
    status: Mapped[str] = mapped_column(String(20), default="accepted", nullable=False, server_default="'accepted'")
