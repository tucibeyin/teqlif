...
feed_query = """from typing import Optional
...
with open(f"{base}/feed_utils.py", "w") as f: f.write(utils)
with open(f"{base}/queries/get_main_feed.py", "w") as f: f.write(feed_query)
print("Generated feed cqrs")
