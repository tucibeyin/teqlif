...
def test_event_bus():
    ...
    def dummy_handler(event: TokenInvalidatedEvent):
...
def test_central_error_handlers():
...
async def test_repository_pattern():
    ...
    async with async_session() as db:
        ...
        try:
            # DB connection başarılıysa none veya obje döner
...
if __name__ == "__main__":
    ...
    try:
        test_event_bus()
        test_central_error_handlers()
        
        # Async test için asyncio loop başlat
