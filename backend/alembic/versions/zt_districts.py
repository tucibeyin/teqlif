"""Create districts table and seed all Turkish provinces with their districts

Revision ID: zt_districts
Revises: zs_listing_new_schema
...
revision: str = "zt_districts"
down_revision: Union[str, Sequence[str], None] = "zs_listing_new_schema"
branch_labels = None
depends_on = None

# Full Turkish province → district map (official administrative divisions)
_DATA: dict[str, list[str]] = {
    ...
    "Afyonkarahisar": [
        "Başmakçı", "Bayat", "Bolvadin", "Çay", "Çobanlar", "Dinar",
        "Emirdağ", "Evciler", "Hocalar", "İhsaniye", "İscehisar",
    ...
    "Bursa": [
        ...
        "Nilüfer", "Orhaneli", "Orhangazi", "Osmangazi", "Yıldırım", "Yenişehir",
    ],
    "Çanakkale": [
    ...
    "Manisa": [
        ...
        "Kırkağaç", "Köprübaşı", "Kula", "Merkez", "Salihli", "Sarıgöl",
    ...
    "Samsun": [
        "Alaçam", "Asarcık", "Atakum", "Ayvacık", "Bafra", "Çarşamba",
        "Havza", "İlkadım", "Kavak", "Ladik", "Ondokuzmayıs",
    ...
    "Tekirdağ": [
        ...
        "Malkara", "Marmaraereğlisi", "Muratlı", "Saray", "Süleymanpaşa", "Şarköy",
    ],
    "Tokat": [
    ...
    "Trabzon": [
        "Akçaabat", "Araklı", "Arsin", "Beşikdüzü", "Çaykara", "Dernekpazarı",
        "Düzköy", "Hayrat", "Köprübaşı", "Maçka", "Of", "Ortahisar",
        "Sürmene", "Şalpazarı", "Tonya", "Vakfıkebir", "Yomra",
    ],
    "Tunceli": [
    ...
    "Yozgat": [
        ...
        "Şefaatli", "Sorgun", "Yenifakılı", "Yerköy",
    ],
    "Zonguldak": [
