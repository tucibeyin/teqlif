    ...
    return (
        <div className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-teal-500 to-cyan-500 text-white px-4 py-3 flex items-center shadow-md">
            ...
            <div className="flex flex-col gap-2 ml-3 flex-shrink-0">
                <a
                    href="#"
                    className="bg-white text-cyan-600 rounded-md shadow-sm flex items-center justify-center hover:bg-teal-50 transition-colors"
                ...
                <a
                    ...
                    style={{ width: "32px", height: "32px" }}
                >
                    <svg viewBox="0 0 512 512" fill="currentColor" style={{ width: "16px", height: "16px" }}>
