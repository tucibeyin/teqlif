                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-section" style={{ background: isAuction ? "rgba(239, 68, 68, 0.05)" : "var(--bg-secondary)", border: isAuction ? "1px solid rgba(239, 68, 68, 0.3)" : "1px solid var(--border)", padding: "1.5rem", borderRadius: "var(--radius-lg)", marginBottom: "2rem" }}>
                            ...
                            <p style={{ marginTop: "1rem", fontSize: "0.875rem", color: "var(--text-muted)" }}>
                                {isAuction
                                    ? "İlanınız belirlediğiniz tarihte canlı yayına girer. Arena Modunda gerçek zamanlı açık artırma düzenleyerek izleyicilerden anında teklif alabilirsiniz."
                                    : "İlanınız hemen yayınlanır. Kendi belirlediğiniz kurallarla teklif toplayabilir veya sabit fiyatla satabilirsiniz."}
                            </p>
                        </div>
