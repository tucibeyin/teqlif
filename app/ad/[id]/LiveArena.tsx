...
export default function LiveArena({
    ...
    return (
        <LiveKitRoom
            ...
            className="w-full h-[650px] bg-neutral-950 flex flex-col md:flex-row relative overflow-hidden rounded-xl"
        >
            <CustomArenaLayout
                adId={adId}
                sellerId={sellerId}
...
function CustomArenaLayout({
    ...
    return (
        <div className="flex flex-col md:flex-row w-full h-full bg-neutral-950 overflow-hidden relative">
            ...
            <div className="flex-1 w-full h-full relative bg-black flex flex-col justify-center items-center overflow-hidden">
                {isOwner && (
                    <button
                        onClick={() => handleEndBroadcast()}
                        className="absolute top-4 right-4 z-[600] bg-red-600/80 hover:bg-red-500 text-white font-black px-6 py-2.5 rounded-full shadow-[0_4px_20px_rgba(220,38,38,0.5)] active:scale-95 transition-all flex items-center gap-2 border border-red-400/50 backdrop-blur-md"
                    >
            ...
            {/* KONTROL PANELİ (Sağ veya Alt) */}
            {!isBroadcastEnded && (
                <div className="w-full md:w-[340px] flex-shrink-0 flex flex-col bg-neutral-900 border-t md:border-t-0 md:border-l border-white/10 relative z-[500] h-[300px] md:h-full p-4">
                    ...
                    <div className="w-full pointer-events-auto flex flex-col gap-3 shrink-0 mt-auto z-[600]">
                        {/* SOHBET INPUTU */}
                        <form
                            onSubmit={(e) => {
                                e.preventDefault();
